<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="2ndSemester.aspx.cs" Inherits="_2ndSemester" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
     <div class="container-fluid">
        ...
        <h1 class="text-center m-3">2nd semester Student Attendance
        </h1>
        <hr />
